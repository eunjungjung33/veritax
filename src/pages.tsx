    ...
    <>
      ...
      <section className="section policy-section">
        ...
        <div className="policy-copy">
          ...
          <h3>3. 제3자 제공 및 처리 환경</h3><p>사무소는 상담 신청 원문을 외부 설문·광고·분석 업체에 제공하지 않습니다. 웹 서비스 운영을 위해 Netlify의 호스팅·서버리스 저장 인프라를 이용하며, 저장되는 원문은 애플리케이션 전용 키로 추가 암호화합니다. 실제 운영 계약의 저장 지역과 국외 이전 고지는 공개 전 운영자가 최종 확인합니다.</p>
